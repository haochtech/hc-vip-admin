...
$GLOBALS['frames'] = $this->getMainMenu();
	$info = pdo_get('zhvip_jfgoods',array('uniacid' => $_W['uniacid'],'id'=>$_GPC['id']));
	$type = pdo_getall('zhvip_jftype',array('uniacid' => $_W['uniacid']));
		if(checksubmit('submit')){
			...
			if($_GPC['id']==''){				
				$res=pdo_insert('zhvip_jfgoods',$data);
				if($res){
				...
				$res = pdo_update('zhvip_jfgoods', $data, array('id' => $_GPC['id']));
				if($res){
