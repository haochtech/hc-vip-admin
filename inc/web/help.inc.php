...
if ($operation == 'display') {
   ...
   $list = pdo_getall('zhvip_help',array('uniacid'=>$_W['uniacid']),array() , '' , 'sort ASC');
       
} elseif ($operation == 'post') {
   $list = pdo_get('zhvip_help',array('id'=>$_GPC['id']));
        if(checksubmit('submit')){
            ...
            if($_GPC['id']==''){
                $res=pdo_insert('zhvip_help',$data);
                if($res){
                ...
                $res = pdo_update('zhvip_help', $data, array('id' => $_GPC['id']));
                if($res){
    ...
    $id=$_GPC['id'];
        ...
        $result = pdo_delete('zhvip_help', array('id'=>$id));
        if($result){
