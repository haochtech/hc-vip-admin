...
if(isset($_GPC['keywords'])){
    $where.=" and (a.user_name LIKE  concat('%', :name,'%') || a.order_num LIKE  concat('%', :name,'%') || b.name LIKE  concat('%', :name,'%') || b.vip_code LIKE  concat('%', :name,'%') || d.name LIKE  concat('%', :name,'%'))";
...
$sql="SELECT a.*,b.name as nickname , b.vip_code,d.name as st_name FROM ".tablename('zhvip_shoporder'). " a"  . " left join " . tablename("zhvip_user") . " b on a.user_id=b.id left join " . tablename("zhvip_stinfo") . " c on c.code=b.vip_code left join " . tablename("zhvip_stlist") . " d on d.id=c.type_id ".$where." ORDER BY a.time DESC";

$total=pdo_fetchcolumn("SELECT count(*) FROM ".tablename('zhvip_shoporder'). " a"  . " left join " . tablename("zhvip_user") . " b on a.user_id=b.id left join " . tablename("zhvip_stinfo") . " c on c.code=b.vip_code left join " . tablename("zhvip_stlist") . " d on d.id=c.type_id ".$where." ORDER BY a.time DESC",$data);
